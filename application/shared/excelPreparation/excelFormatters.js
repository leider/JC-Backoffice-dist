...
export function createExcelData({ veranstaltung, optionen }) {
    ...
    return veranstaltung.isVermietung
        ? createExcelDataVermietung(veranstaltung)
        : createExcelDataKonzert(veranstaltung);
    function createExcelDataKonzert(konzert) {
    ...
    function createExcelDataVermietung(vermietung) {
