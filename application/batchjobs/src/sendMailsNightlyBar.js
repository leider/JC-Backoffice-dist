...
export async function checkBar(now) {
    function formatVeranstaltung(veranstaltung) {
        function textFuerBesucher() {
            const erwartete = !veranstaltung.isVermietung && veranstaltung.eintrittspreise.erwarteteBesucher;
    ...
    try {
        ...
        const filterFunction = (ver) => {
            const typOk = !ver.isVermietung ? !ver.kopf.eventTyp.startsWith("DryJam") : ver.brauchtBar;
